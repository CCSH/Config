...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "77", "type_name": "电影"},
                            {"type_id": "78", "type_name": "剧集"},
                            {"type_id": "80", "type_name": "动漫"},
                            {"type_id": "164", "type_name": "4K"},
                            {"type_id": "79", "type_name": "综艺"},
                            {"type_id": "166", "type_name": "体育"},
                            {"type_id": "170", "type_name": "演唱会"},
                            {"type_id": "165", "type_name": "短剧"}],
    ...
    def detailContent(self, ids):
        ...
        content = 'self.extract_middle_text(res,'class="text cor3" >','</div>', 0)
