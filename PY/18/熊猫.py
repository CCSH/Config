...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        result = {}
        result['class'] = []
        result['class'].append({'type_id': 1, 'type_name': "最新传媒"})
        result['class'].append({'type_id': 2, 'type_name': "最新视频"})
        result['class'].append({'type_id': 3, 'type_name': "最新电影"})
    ...
    def detailContent(self, ids):
        ...
        videos.append({
            "vod_id": did,
            "vod_name": '',
            "vod_pic": js1['data']['macVodLinkMap'][svid]['PIC_LINK_1'] + json_dict['data']["result"]["vod_pic"],
            "type_name": json_dict["data"]["result"]["typeName"],
            "vod_year": "",
            "vod_area": "",
            "vod_remarks": "",
            "vod_actor": "",
